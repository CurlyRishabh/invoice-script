...
with open('b2c_sample.csv', 'r', encoding='utf-8') as csvfile:
    ...
    for row in reader:
        try:
            ...
            pincode = row['Pin Code'] if row['Pin Code'] !=0 else '560017'
            # break
            rendered_html = template.render(
                ...
                city=city,
                pincode=pincode,
                state_code=state_codes.get(row['State'].lower(), '29'),
